...
export default function Experience() {
  ...
  const openMacsPopup = () => setIsMacsPopupOpen(true);
  const closeMacsPopup = () => setIsMacsPopupOpen(false);

  const macsPopupContent = (
    <div>
      <h4>Work</h4>
  ...
  const openGoStudentPopup = () => setIsGoStudentPopupOpen(true);
  const closeGoStudentPopup = () => setIsGoStudentPopupOpen(false);

  const goStudentPopupContent = (
    <div>
      <h4>Work</h4>
  ...
  const openOifemPopup = () => setIsOifemPopupOpen(true);
  const closeOifemPopup = () => setIsOifemPopupOpen(false);

  const oifemPopupContent = (
    <div>
      <h4>Volunteering</h4>
      <p>2022 - current</p>
      <p>
  ...
  const openComputersPopup = () => setIsComputersPopupOpen(true);
  const closeComputersPopup = () => setIsComputersPopupOpen(false);

  const computersPopupContent = (
    <div>
      <h4>Volunteering</h4>
      <p>2021</p>
      <p>
  ...
  const openPhonesPopup = () => setIsPhonesPopupOpen(true);
  const closePhonesPopup = () => setIsPhonesPopupOpen(false);

  const phonesPopupContent = (
    <div>
      <h4>Volunteering</h4>
      <p>2020</p>
      <p>
  ...
  const experiences = [
    { title: "M.A.C.S", startTime: 2024, endTime: 2024, type: "work", open: openMacsPopup },
